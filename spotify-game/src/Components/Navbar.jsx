...
return(
    <div className="Navbar-Container">
        ...
        <input type="text" placeholder="Search Artist" onChange={(e)=>props.Navbarsearch(e.target.value)} className="Navbar-Searchbar"/>
       ...
       {cookies.session!=undefined && <ul className="Right-Navbar">
            <p id="navbar-username" onClick={()=>Signout()}>{cookies.Username}</p>
        </ul>}
        </div>
    </div>
)
