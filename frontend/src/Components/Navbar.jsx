...
return(
  ...
  debounceTimeout={500} type="text" placeholder="Search Artist" onChange={(e)=>props.Navbarsearch(e.target.value)} className="Mobile-Searchbar" onFocus={()=>{
    ...
    <div id="mobile-links">
      <div class="mobile-link" onClick={()=>{navigate('/')}}><span>Home</span><i></i></div>
      <div class="mobile-link" onClick={()=>{navigate('/ScoreHistory')}}><span>My Scores</span><i></i></div>
      <div class="mobile-link"><span>Leaderboard</span><i></i></div>
